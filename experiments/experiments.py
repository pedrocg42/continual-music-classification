...
continual_learning_icarl_trainer_scenario1 = deepcopy(continual_learning_icarl_trainer)
continual_learning_icarl_trainer_scenario1["args"]["tasks"] = scenario1
...
continual_learning_l2p_evaluator_scenario1 = deepcopy(continual_learning_evaluator_l2p)
continual_learning_l2p_evaluator_scenario1["args"]["tasks"] = scenario1
...
mert95m_icarl_cl_gtzan_scenario1 = {
    ...
    # data
    "train": {
        "trainer": continual_learning_icarl_trainer_scenario1,
    },
    "evaluate": {
        "evaluator": continual_learning_evaluator_scenario1,
    },
...
mert95m_l2p_cl_gtzan_scenario1 = {
    ...
    "evaluate": {
        "evaluator": continual_learning_l2p_evaluator_scenario1,
    },
}
