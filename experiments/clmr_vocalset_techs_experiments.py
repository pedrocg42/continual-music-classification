...
clmrsamplecnn_l2p_cl_vocalsettech_scenario1 = {
    "experiment_name": "clmrsamplecnn_l2p_cl_vocalsettech_scenario1",
    "experiment_type": "CL",
...
clmrsamplecnn_l2p_cl_vocalsettech_scenario2 = {
    "experiment_name": "clmrsamplecnn_l2p_cl_vocalsettech_scenario2",
    "experiment_type": "CL",
    "experiment_subtype": "L2P",
    # data
    "train": {
...
clmrsamplecnn_l2p_cl_vocalsettech_scenario3 = {
    "experiment_name": "clmrsamplecnn_l2p_cl_vocalsettech_scenario3",
    "experiment_type": "CL",
    "experiment_subtype": "L2P",
    # data
    "train": {
